...
class TestListInstructorTaskInput(unittest.TestCase):
    """ListInstructorTaskInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInstructorTaskInput:
        """Test ListInstructorTaskInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInstructorTaskInput`
        """
        model = ListInstructorTaskInput()
        if include_optional:
            return ListInstructorTaskInput(
    ...
    def testListInstructorTaskInput(self):
        """Test ListInstructorTaskInput"""
