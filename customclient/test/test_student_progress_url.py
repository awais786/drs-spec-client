...
class TestStudentProgressUrl(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StudentProgressUrl:
        """Test StudentProgressUrl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudentProgressUrl`
        """
        model = StudentProgressUrl()
        if include_optional:
            return StudentProgressUrl(
    ...
    def testStudentProgressUrl(self):
        """Test StudentProgressUrl"""
