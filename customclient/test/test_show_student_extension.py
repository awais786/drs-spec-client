...
class TestShowStudentExtension(unittest.TestCase):
    """ShowStudentExtension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowStudentExtension:
        """Test ShowStudentExtension
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowStudentExtension`
        """
        model = ShowStudentExtension()
        if include_optional:
            return ShowStudentExtension(
                student = ''
            )
        else:
            return ShowStudentExtension(
    ...
    def testShowStudentExtension(self):
        """Test ShowStudentExtension"""
