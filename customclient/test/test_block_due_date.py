...
class TestBlockDueDate(unittest.TestCase):
    """BlockDueDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlockDueDate:
        """Test BlockDueDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlockDueDate`
        """
        model = BlockDueDate()
        if include_optional:
            return BlockDueDate(
