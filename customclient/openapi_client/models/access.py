...
class Access(BaseModel):
    ...
    """ # noqa: E501
    unique_student_identifier: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Email or username of user to change access")
    rolename: StrictStr = Field(description="Role name to assign to the user")
    action: ActionEnum = Field(description="Action to perform on the user's access  * `allow` - allow * `revoke` - revoke")
    __properties: ClassVar[List[str]] = ["unique_student_identifier", "rolename", "action"]
